...
<head>
	...
	<script type="text/javascript">
		    	function SubmitForm() {
			        ...
			        document.form.action = "Import_FileData.asp";
	...
	<div class="container">
		<div><!--Heading-->
			<table width="60%" border="0" align="center" cellpadding="0" cellspacing="1">
				...
				<tr>
					<td height="20" colspan="4" bgcolor="6E6E6B" class="labledesidebar">&nbsp;<img src="../images/arrow.gif" width="13" height="12" align="absmiddle"> &nbsp;Upload PTO File</td>
				</tr>
				<tr>
		...
		<form name="form" action="upload.asp" method="POST" enctype="multipart/form-data" role="form">
			...
			<table width="60%" border="0" align="center" cellpadding="0" cellspacing="1">
				<tr>
    				<td height="22" colspan="2" class="Ntablerow1bold">&nbsp;Upload PTO File</td>
  				</tr>
				<tr>
